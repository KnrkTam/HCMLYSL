...
class Express_checkout extends CI_Controller
{
	...
	function index()
	{
        ...
        $cart['order_items'] = array(
            array(
                'name'   => 'Demo',
                'desc'   => 'This is demo product',
                'amt'    => '9.99',
                'qty'    => 1,
                'taxamt' => 1.99,
            )
	...
	function SetExpressCheckout()
	{
		...
		$SECFields = array(
			...
			'returnurl' => front_url('paypal/demos/express_checkout/GetExpressCheckoutDetails'), 							    // Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
			'cancelurl' => front_url('paypal/demos/express_checkout/OrderCancelled'), 							    // Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
			'hdrimg' => 'https://dummyimage.com/750x90/000/fff', 			// URL for the image displayed as the header during checkout.  Max size of 750x90.  Should be stored on an https:// server or you'll get a warning message in the browser.
			'logoimg' => 'https://dummyimage.com/190x60/000/fff', 					// A URL to your logo image.  Formats:  .gif, .jpg, .png.  190x60.  PayPal places your logo image at the top of the cart review area.  This logo needs to be stored on a https:// server.
			...
			'customerservicenumber' => '852-12345678', 				                                // Merchant Customer Service number displayed on the PayPal Review page. 16 char max.
		);
	...
	function DoExpressCheckoutPayment()
	{
		...
		$Payment = array(
			...
			'currencycode' => 'HKD', 					                                // A three-character currency code.  Default is HKD.
