...
class Bk_year_comments extends CI_Controller //change this
{
    private $scope = 'year_comments'; //change this
    ...
    public function page_setting($permission, $return = TRUE, $redirect = FALSE)
    {
        $page_setting = array(
            ...
            'scope' => __('全年學行評語 - 檢視'), //change this
    ...
    public function detail()
    {
        ...
        $GLOBALS["select2"] = 1;
        $GLOBALS["datatable"] = 1;
        $this->load->view('webadmin/' . $this->scope . '_detail',  $data);
    }
