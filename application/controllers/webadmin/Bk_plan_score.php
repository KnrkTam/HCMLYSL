...
class Bk_plan_score extends CI_Controller //change this
{
    private $scope = 'plan_score'; //change this
    ...
    public function page_setting($permission, $return = TRUE, $redirect = FALSE)
    {
        $page_setting = array(
            ...
            'scope' => __('教學計劃評分 - 檢視'), //change this
    ...
    public function create01()
    {
        ...
        $this->load->view('webadmin/' . $this->scope . '_step1',  $data);
    }
