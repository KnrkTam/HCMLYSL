...
class bk_news_ajax extends CI_Controller
{
    private $scope = 'news_ajax';
    private $langcode = '';
    ...
    public function page_setting($permission, $return = TRUE)
    {
        $page_setting = array(
    ...
    public function create()
    {
        ...
        $data['form_list'] = News_ajax_model::form_list();
