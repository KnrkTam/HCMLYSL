...
<head>
    <meta charset="utf-8">
    <title>Express Checkout - Basic</title>
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <div class="alert alert-info">
                ...
                Email Address:  paypal_demo@onesolution.com.hk<br />
                Password:  31899000
                </p>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-4 column">
                    <table class="table">
                        ...
                        <tr>
                            <td class="center" colspan="2"><a href="<?php echo front_url('paypal/demos/express_checkout/SetExpressCheckout'); ?>">
