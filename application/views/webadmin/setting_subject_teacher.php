                    ...
                    <input type="hidden" name="id" value="<?= $id ?>"/>-->
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group ">
                                            ...
                                            <select class="form-control">
                                                <option hidden>請選擇...</option>
                                                <option value="語文科123">語文科123</option>
                                ...
                                <button type="button" class="btn bg-orange mw-100 mb-4" onclick="location.href='../webadmin/Bk_setting_subject_teacher/create';">新 增</button>
