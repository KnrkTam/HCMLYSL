                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <?php form_list_type('position_id', ['type' => 'select', 'class'=> 'form-control select2' , 'data-placeholder' => '請選擇...', 'value' => $position_id, 'enable_value' => $positions_list, 'form_validation_rules' => 'trim|required']) ?>
