                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <select class="form-control">
                                                ...
                                                <option value="聽懂初階單元動詞及形容詞" selected>聽懂初階單元動詞及形容詞</option>
                                                <option value="聽懂初階單元動詞及形容詞">聽懂初階單元動詞及形容詞</option>
                                ...
                                <div class="mt-4 d-flex justify-content-end">
                                    <button type="button" class="btn btn-primary mw-100 mb-4 mr-4" onclick="location.href='../Bk_addon/preview';">確 定</button>
