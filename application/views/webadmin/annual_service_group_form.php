...
<body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <div style="flex: 1"><?php form_list_type('service_id', ['type' => 'select', 'class'=> 'form-control select2' ,  'data-placeholder' => '請選擇...', 'enable_value' => $services_list, 'form_validation_rules' => 'trim|required']) ?></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        submitBtn.addEventListener("click",function(){
            validateForm(year_id.value, service_id.value, $("#module_id").select2("val"), staff1_id.value, staff2_id.value, $("#other_staff_id").select2("val"), $("input[type='radio'][name='group_name']:checked").val(), class_id.value, custom_group_name.value,$("#student_id").select2("val"),);
            function validateForm(year_id, service_id, module_id, staff1_id, staff2_id, other_staff_id, group_name, class_id, custom_group_name, student_id){
                $.ajax({
