...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                    ...
                    <input type="hidden" name="id" value="<?= $id ?>"/>-->
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <button type="button" class="btn bg-orange mw-100 mb-4" data-toggle="modal" data-target="#attendance">匯入出席紀錄</button>
                                    ...
                                    <table class="table table-bordered table-striped w-100" id="settingTable">
                                        <thead>
                                            <tr class="bg-light-blue color-palette">
                                                ...
                                                <th class="nowrap">學生</th>
                                                <th class="nowrap">應上課(天數)</th>
                                                <th class="nowrap">缺席(天數)</th>
        ...
        <!-- Modal -->
        <div class="modal fade in" tabindex="-1" role="dialog" id="attendance">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title bold">匯入出席紀錄<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" id="unit">
                                    <option hidden>請選擇...</option>
                                    <option value="單元一">單元一</option>
                                    <option value="單元二">單元二</option>
                                </select>
                            </div>
