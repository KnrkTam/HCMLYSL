                    ...
                    <input type="hidden" name="id" value="<?= $id ?>"/>-->
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <button type="button" class="btn bg-orange mw-100 mb-4" onclick="location.href='../webadmin/Bk_subject_level/create';">新 增</button>
                                    ...
                                    <table class="table table-bordered table-striped w-100" id="settingTable">
                                        <thead>
                                            <tr class="bg-light-blue color-palette">
                                                ...
                                                <th class="nowrap">本年度已確認級別</th>
                                                <th class="nowrap">建議下年度級別</th>
                                                <th class="no-sort"></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link" href="../webadmin/Bk_subject_level/edit">修改</span></a>
                                                </td>
                                            </tr>
                                            <tr>
