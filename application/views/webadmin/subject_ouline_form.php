                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control inputCourseNumber" placeholder="e.g.: #SC557, #BD003" value="" readonly>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control remarks">
                                                <option hidden>請選擇...</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="studyresults" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <label>關鍵表現項目：</label>
                                        ...
                                        <div class="row align-items-center performanceItem">
                                            <div class="col-lg-4">
                                                <div class="form-group mb-3 w-100">
                                                    <input type="text" class="form-control" id="performanceItemDetail" value="">
                                                </div>
                                            </div>
