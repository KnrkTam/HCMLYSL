                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <ul class="colorMapList inlinelist">
                                    <li class="text-purple bold">科目</li>
                                    <li class="text-red bold">科目範疇</li>
                                    <li class="text-green bold">科目課程</li>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="nav-header text-nowrap text-purple mr-2"><span class="nav-toggle-icon"><i class="fa fa-fw  fa-search-plus"></i>科目：</span> </label>
                                    ...
                                    <div class="col-lg-1">
                                        <button type="submit" class="btn btn-primary mt-30 w-100 searchBtn" >搜 尋</button>
                                    </div>
                                </div>            
                                <hr>
                                <div class="map-body">
                                        ...
                                        <ul class="nav nav-list nav-left-ml">
                                            ...
                                            <?php foreach (Key_performances_model::subject_cat_lesson($lesson->id, $cat->id) as $row) {?>
                                                ...
                                                <ul class="nav nav-list nav-left-ml lastList">
                                                    <li class="text-orange"><?= $foo->performance?></li>
                                                    ...
                                                    <?php if (!count($row) ) { ?>
                                                        <ul class="nav nav-list nav-left-ml lastList">
                                                            <li class="text-muted">未有關鍵表現項目</li>
                                                        </ul>
                                                    <? } ?>
                                                <? } ?>
                                                </li>
